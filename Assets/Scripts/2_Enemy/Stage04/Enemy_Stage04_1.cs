...
public class Enemy_Stage04_1 : EnemyBase // Mage 스크립트
{
    ...
    {
        maxHp = 70f; // 적 체력 설정
        currentHp = 35f; // 적 체력 초기화
        damage = 7f; // 적 공격력 설정 
        maxGroggyCnt = 2; // 최대 그로기 게이지 3개로 설정
    ...
    private IEnumerator Attack1()
    {
        ...
        attackObjects[1].SetActive(true); // 공격범위 활성화
        yield return new WaitForSeconds(0.1f);

        attackObjects[1].SetActive(false); // 공격범위 비활성화
